...
const initialState = {
    ...
    Success: false,
    Loading: false,
    // bookingCompletedTotalAmount: null,
    // bookingReservedTotalAmount: null,
...
export const bookingSlice = createSlice({
    ...
    reducers: {
        reset: (state) => {
            ...
            state.Success = false;
            state.Error = false;
            // (state.bookingCompletedTotalAmount = null),
            //     (state.bookingReservedTotalAmount = null),
    ...
    extraReducers: {
        ...
        [BookingData.fulfilled]: (state, action) => {
            ...
            state.Success = true;
            state.Error = false;
            // (state.bookingCompletedTotalAmount = action.payload.bookingCompletedTotalAmount),
            //     (state.bookingReservedTotalAmount = action.payload.bookingReservedTotalAmount),
